  ...
  class EGMControl {
    ...
    bool callback_start_RAPID_EGM_control(std_srvs::SetBool::Request &req, std_srvs::SetBool::Response &res){
      ...
      if (req.data)
      {
        ...
        ros::Duration(1).sleep(); // sleep for 1s. Time required to correctly start RAPID. CHECK IF THIS DELAY IS NEEDED!
        //-----------------------
        ...
        in_EGM_settings_srv.request.task = "T_ROB_R";
        ...
        {        
          ...
          if (in_EGM_settings_srv.response.result_code == 1)
          {
            ...
            out_EGM_settings_srv.request.task = "T_ROB_R";
        ...
        //-----------------------
        ROS_WARN("Sleeping for 1 sec...");
        ros::Duration(1).sleep(); // sleep for 1s. Time required to correctly set parameters. CHECK IF THIS DELAY IS NEEDED!
        //-----------------------
        ...
        start_controller_srv.request.start_controllers = {"joint_position_trajectory_controller_r"};
        ...
        //-----------------------
        ROS_WARN("Sleeping for 1 sec...");
        ros::Duration(1).sleep(); // sleep for 1s. Time required to correctly start controllers. CHECK IF THIS DELAY IS NEEDED!
        //-----------------------
    ...
    bool callback_stop_EGM_RAPID_control(std_srvs::SetBool::Request &req, std_srvs::SetBool::Response &res){
      ...
      if (req.data)
      {
        ...
        //-----------------------
        ROS_WARN("Sleeping for 2 sec...");
        ros::Duration(2).sleep(); // sleep for 1s. Time required to get correctly current state. CHECK IF THIS DELAY IS NEEDED!
        //-----------------------
...
int main (int argc, char **argv)
{
  ...
  EGMControl yumi_EGM_control = EGMControl(&nh);
